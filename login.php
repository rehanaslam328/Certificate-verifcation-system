<?php
  ...
  include_once('connection.php');
	...
	$adminquery= "select * from users where   userName='$un' and userpass = '$up' and category='Admin'";
	$admin_run= mysqli_query($con,$adminquery) or die("Error in Query");

     $studentquery= "select * from users where   userName='$un' and userpass = '$up' and category='Student'";
	...
	if(mysqli_num_rows($admin_run)>0){ 
		$_SESSION['id']=$id;
		$_SESSION['myuser']=$un;
		echo "<script>location='admin/adminview.php'</script>";
	}
